  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: MouseRegion(
        ...
        child: BeforeAfter(
          before: Image.asset('assets/images/pic.png', fit: BoxFit.cover),
          after: Image.asset('assets/images/pic2.png', fit: BoxFit.cover),
          height: 500,
          width: 700,
          thumbHeight: 24.0,
          thumbWidth: 24.0,
    ...
    return Padding(
      ...
      child: GestureDetector(
        onHorizontalDragUpdate: (details) {
          setState(() {
            // Calculate the new thumb position based on the drag gesture
            thumbPosition += details.primaryDelta! / 300; // 300 is the width of the BeforeAfter widget
            thumbPosition = thumbPosition.clamp(0.0, 1.0);
          });
        },
        child: BeforeAfter(
...
Widget horizontalWidgetBasedOnScreenType(BuildContext context) {
  ...
  return Container(); // Return a default widget or an empty container for other screen types.
}
